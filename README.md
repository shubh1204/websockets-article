# Websocket based Streaming with Fast API and Local LLAMA 3 [Article Link](https://medium.com/@shubham.mdsk/websocket-based-streaming-with-fast-api-and-local-llama-3-46f88eda71a2)
